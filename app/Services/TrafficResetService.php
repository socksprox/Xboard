...
class TrafficResetService
{
   ...
   *
   * Logic:
   * 1. Use expired_at as reference date, or created_at for permanent accounts.
   * 2. Use the day of the reference date as the monthly reset day.
   ...
   * Logic:
   * 1. Use expired_at as reference date, or created_at for permanent accounts.
   * 2. Use the month and day of the reference date as the yearly reset date.
