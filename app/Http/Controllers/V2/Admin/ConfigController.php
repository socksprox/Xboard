    ...
    private function getConfigMappings(): array
    {
        return [
            ...
            'subscribe' => [
                ...
                'restart_cycle_enable' => (bool) admin_setting('restart_cycle_enable', 1),
                'restart_cycle_require_depleted' => (bool) admin_setting('restart_cycle_require_depleted', 1),
                'restart_cycle_depleted_threshold' => (int) admin_setting('restart_cycle_depleted_threshold', 100),
                'restart_order_event_id' => (int) admin_setting('restart_order_event_id', 0),
                'purchase_suggestion_enable' => (bool) admin_setting('purchase_suggestion_enable', 1),
